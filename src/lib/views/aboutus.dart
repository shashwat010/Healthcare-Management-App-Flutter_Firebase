            ...
            child: Column(
              ...
              children: <Widget>[
                const ListTile(
                  ...
                  subtitle: Text(
                      'This community healthcare management app (RunOn app) built in Flutter Firebase App for iOS, Android, Web & Desktop. Complete Healthcare Hospital Management (Patient, OPD, IPD, Rx, Lab) in Flutter Firebase App for iOS, Android, Web & Desktop.\n\nThis project is a community version and is absolutely free for private use.'),
                ),
                const ListTile(
                  leading: Icon(
                    Icons.album,
                ...
                const ListTile(
                  ...
                  subtitle: Text(
                      'send email to .com for Pro version enquiries.'),
                ),
                const ListTile(
                  leading: Icon(
                    Icons.lock_open,
